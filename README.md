...
![IDIN logo](https://github.com/nimbles-nl/cm-telecom/blob/master/logo/IDIN_logo_64_pixels.png) IDIN is used for personal identification by bank and is supported by Dutch banks.
